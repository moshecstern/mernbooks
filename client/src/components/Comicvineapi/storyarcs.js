...
function savevoltoprofile (myname, myimg, myaliases, mydesc, mydeck, mynumissues, mylink, mybirth) {
                ...
                //   title={<Link to={"/series/" + item.name}>{item.name}</Link>}
                  ...
                  <FavoriteBorderOutlinedIcon 
                        onClick={() =>
                            ...
                            savevoltoprofile(item.name, item.image.medium_url, item.aliases, item.description, item.deck, item.count_of_issue_appearances, item.site_detail_url, item.birth)
                        }
                      />
                  </>}
                  subtitle={
                    <>
                      {/* <span>First Apeared: </span>
                      <br />

                      {!item.first_appeared_in_issue.name ? null : (
                      <span>Name: {item.first_appeared_in_issue.name}</span>
                      )}
                      <span> Number: {item.first_appeared_in_issue.issue_number} </span> 
                      <br /> */}
