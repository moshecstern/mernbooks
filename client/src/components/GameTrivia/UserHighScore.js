...
const UserHighScore = props => {
    ...
    const [{ data: triviascore, loading }, randomtext] = useAxios({
        url: "/api/userhighscoretrivia/" + jwtDecode(accessString).id,
        headers: { Authorization: `JWT ${accessString}` }
      });

      function deleteScore(id){
        console.log(id)
        Axios.delete("/api/userhighscoretrivia/"+ id, {headers: { Authorization: `JWT ${accessString}` }})
        .then(res => randomtext())
